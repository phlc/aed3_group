...
/*
ArvoreBMais_Short_Long 
Indice direto para apontar a posição no arquivo de registros apagados
Adaptação a partir do cógido ArvoreBmais_String_Int.java
*/
...
// CHAVE: Short - Tamanho do arquivo
// VALOR: Long - Posição no arquivo

public class ArvoreBMais_Short_Long {
