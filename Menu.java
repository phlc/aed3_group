...
public class Menu{
   ...
   */
   ...
   /**
    * telaGerenciarPerguntas - Apresenta a tela de gerenciamento de perguntas
    */
   public static void telaGerenciarPerguntas(){
      clear();
    ...
    */
   public static void telaMinhasPerguntas() throws Exception{
      System.out.println(Pergunta.getList(online.getID()));
      pause(leitor);
   }
